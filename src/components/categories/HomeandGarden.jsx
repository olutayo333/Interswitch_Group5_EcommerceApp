  ...
  return (
    <div className='container-fluid'>
      ...
      <div className='row mx-lg-5 mx-auto'>
          <h2 className='mt-5'>Home and Garden</h2>
          {/* <div className=" grid lg:grid-col-6 md:grid-col-3 grid-col-2"> */}
            {
              products.map((items, index) => ( 
              <div  className="col-lg-2 col-md-3 col-12 rounded bg-white justify-center items-center pt-2 shadow mx-2 my-2" key={items.id}>
